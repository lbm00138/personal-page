const personalarray = {"終極井字遊戲" :
`
                <p class="personalgraph">
                    終極井字遊戲&nbsp;&nbsp;
                    <button class="personalbutton" onclick = "location.href = 'https://tic-119788516387.asia-east1.run.app/'">前往頁面</button>
                </p>
                <table border="0">
                    <tr>
                        <td class = "personaltdimage">
                            <img src="./專案 1.png" style = "width : 450px;height : 380px;">
                        </td>
                        <td class = "personaltdtext">
...
`
                <p class="personalgraph">
                    KQlator&nbsp;&nbsp;
                    <button class="personalbutton" onclick = "location.href = 'https://github.com/lbm00138/KQlator'">前往頁面</button>
                </p>
                <table border="0">
                    <tr>
                        <td class = "personaltdimage">
                            <img src="./專案 2.png" style = "width : 450px;height : 380px;">
                        </td>
                        <td class = "personaltdtext">
                            這是我選修 Labview 程式語言時做的第一個專案，是個簡易的計算機，功能如下 :<br>
                            1.基本加減乘除的功能<br>
                            2.可以進行括號運算<br>
                            3.可以儲存兩個運算結果<br>
                            4.精確度與顯示數值到小數點後六位<br>
                            5.當使用者輸入不合法的表達式時會報錯<br>
                            6.可以執行 sqrt()<br>
                            這個專案我最後拿到了 85 分，製作過程中我也第一次體驗了用新的接線程式語言寫專案以及 Debug 的過程。專案放在 GitHub 上，點擊藍色按鈕就可看到。
                        </td>
                    </tr>
                </table>
                <br>
                ...
                <table border="0">
                    <tr>
                        ...
                        <td class = "personaltdtext">
                            ...
                            <br>
                            在「白晝之夜」中，會有許多靜態與動態的展覽、燈光秀、音樂會等。還有許多市集前往圓山擺攤。在活動中，我看到了許多有趣的藝術作品。
令我印象最深刻的作品是一個類似拼湊方塊的展覽，那一區有很多奇形怪狀的方塊可以給我們市民自由組合。當時就有很多小朋友在那裡玩。我當天就把幾個方塊拼成一個類似石像的東西。這讓我瞭解了展覽不一定要靜態的，可以是動態的。透過市民與展覽品的互動，反而能展出各式各樣的酷東西。
                        </td>
                    </tr>
                </table>
                <br> 
...
`
                ...
                <table border="0">
                    <tr>
                        <td class = "personaltdimage">
                            <img src="./自造者社拼圖.jpg" style = "width : 450px;height : 380px;">
                        </td>
                        <td class = "personaltdtext">
...
`
               <p class="personalgraph">
                ...
                <table border="0">
                    <tr>
                        <td class = "personaltdimage">
                            <video src="./Scratch 賽馬場.MOV" style = "width : 450px;height : 380px;" controls="controls" autoplay="autoplay"></video>
                        </td>
                        <td class = "personaltdtext">
...
`
                ...
                <table border="0">
                    <tr>
                        <td class = "personaltdimage">
                            <div class="L4graph2x2">
                                <img src="./新竹動物園 01.jpg">
                                <img src="./新竹動物園 02.jpg">
                                <img src="./新竹動物園 03.jpg">
                                <img src="./新竹動物園 04.jpg">
                            </div>
                        </td>
                        <td class = "personaltdtext">
...
function Searchitems(){
    ...
    for (const key in personalarray){
        if (key.includes(keyword)){
            SearchPersonalArray.push(personalarray[key]);
        }
    }
    document.getElementById("showpersonalarea").innerHTML = SearchPersonalArray.join("");
}
